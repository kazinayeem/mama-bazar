            ...
            return (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="truncate text-xs font-bold text-slate-900 sm:text-[13px]">{item.title}</p>
                  {item.text && <p className="mt-0.5 truncate text-[11px] text-slate-500">{item.text}</p>}
                </div>
              </div>
            )
          })}
