...
const NewsletterBlock = ({ settings }: NewsletterBlockProps) => {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-primary-700 via-primary to-brand px-6 py-14 shadow-glow sm:px-12">
        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-2">
          ...
          <form className="flex flex-col gap-3 rounded-[18px] border border-white/25 bg-white/10 p-3 backdrop-blur-md sm:flex-row" onSubmit={handleSubmit}>
            <input
