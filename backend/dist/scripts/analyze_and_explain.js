...
async function main() {
    ...
    await db_1.db.execute(drizzle_orm_1.sql.raw("ANALYZE TABLE `products`"));
    await db_1.db.execute(drizzle_orm_1.sql.raw("ANALYZE TABLE `reviews`"));
    ...
    for (const q of queries) {
        ...
        console.log(`========================================================`);
        const res = await db_1.db.execute(drizzle_orm_1.sql.raw(`EXPLAIN ${q.sql}`));
...
//# sourceMappingURL=analyze_and_explain.js.map