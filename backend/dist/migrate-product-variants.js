...
async function runMigrations() {
    try {
        ...
        await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE order_items ADD COLUMN IF NOT EXISTS variant_id INT`);
        await db_1.db.execute((0, drizzle_orm_1.sql) `ALTER TABLE order_items ADD FOREIGN KEY IF NOT EXISTS fk_order_items_variant (variant_id) REFERENCES product_variants(id)`);
