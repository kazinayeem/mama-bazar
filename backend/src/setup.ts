...
async function setup() {
  ...
  try {
    ...
    await conn.execute(
      ...
      ["Admin", "admin@ghorerbazar.com", hashedPassword, "admin"]
    );
    ...
    await conn.execute(
      `INSERT IGNORE INTO site_settings (\`key\`, value) VALUES (?, ?)`,
      ["notice_text", "আমাদের যে কোন পণ্য অর্ডার করতে কল করুন অথবা WhatsApp করুন: 01XXXXXXXXX | সারা বাংলাদেশে হোম ডেলিভারি 🚚"]
    );
